...
tokens {
 ASSIGN, BLOCK_START, BLOCK_END, DATA_PIPE, LIST_START, LIST_END, SEQUENCE_RANGE, GROUP_START, GROUP_END, OP_ARITH, LIT_TRUE, LIT_FALSE, OP_LOGIC, OP_STR, FUNC_DEF, FUNC_CALL, RETURN, PRINT, INPUT, IF, ELSE, LOOP, REV, COMMENT, ID, LIT_NUM, LIT_STR, NOT, COMMA
}
