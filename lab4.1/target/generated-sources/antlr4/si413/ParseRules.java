...
public class ParseRules extends Parser {
	...
	public static final int
		...
		SEQUENCE_RANGE=7, STRING_START=8, STRING_END=9, GROUP_START=10, GROUP_END=11, 
		OP_ARITH=12, LIT_TRUE=13, LIT_FALSE=14, OP_LOGIC=15, OP_STR=16, FUNC_DEF=17, 
		FUNC_CALL=18, RETURN=19, PRINT=20, INPUT=21, IF=22, ELSE=23, LOOP=24, 
		REV=25, COMMENT=26, ID=27, LIT_NUM=28, LIT_STR=29, NOT=30, COMMA=31;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"LIST_END", "SEQUENCE_RANGE", "STRING_START", "STRING_END", "GROUP_START", 
			"GROUP_END", "OP_ARITH", "LIT_TRUE", "LIT_FALSE", "OP_LOGIC", "OP_STR", 
			"FUNC_DEF", "FUNC_CALL", "RETURN", "PRINT", "INPUT", "IF", "ELSE", "LOOP", 
			"REV", "COMMENT", "ID", "LIT_NUM", "LIT_STR", "NOT", "COMMA"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2071880736L) != 0)) {
				{
				{
				setState(27);
				stat();
	...
	public final List_structureContext list_structure() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2047239200L) != 0)) {
				{
				setState(80);
				expr_list();
				}
