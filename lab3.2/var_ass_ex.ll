...
define i32 @main() {
  %reg1 = getelementptr inbounds [6 x i8], [6 x i8]* @lit1, i64 0, i64 0
  %reg2 = alloca i8*, align 8
  store i8* %reg1, i8** %reg2
  %reg3 = or i1 true, true
  %reg4 = alloca i1, align 1
  store i1 %reg3, i1* %reg4
  %reg5 = load i1, i1* %reg4
  br i1 %reg5, label %if_true_L1, label %if_false_L1
if_true_L1:
  %reg6 = getelementptr inbounds [4 x i8], [4 x i8]* @lit2, i64 0, i64 0
  %reg7 = getelementptr inbounds [4 x i8], [4 x i8]* @lit3, i64 0, i64 0
  %reg8 = call i8* @concat_strings(i8* %reg6, i8* %reg7)
  %reg9 = getelementptr inbounds [6 x i8], [6 x i8]* @lit4, i64 0, i64 0
  %reg10 = call i8* @concat_strings(i8* %reg8, i8* %reg9)
  %reg11 = load i8*, i8** %reg2
  %reg12 = call i8* @concat_strings(i8* %reg10, i8* %reg11)
  call i32 @puts(i8* %reg12)
  br label %if_end_L1
if_false_L1:
  br label %if_end_L1
if_end_L1:
...
@lit1 = constant [6 x i8] c"olleh\00"
@lit2 = constant [4 x i8] c"one\00"
@lit3 = constant [4 x i8] c"two\00"
@lit4 = constant [6 x i8] c"three\00"
