...
define i32 @main() {
  %reg1 = or i1 true, true
  %reg2 = alloca i1, align 1
  store i1 %reg1, i1* %reg2
  %reg3 = load i1, i1* %reg2
  br i1 %reg3, label %if_true_L1, label %if_false_L1
if_true_L1:
  %reg4 = getelementptr inbounds [6 x i8], [6 x i8]* @lit1, i64 0, i64 0
  call i32 @puts(i8* %reg4)
  br label %if_end_L1
if_false_L1:
  %reg5 = getelementptr inbounds [6 x i8], [6 x i8]* @lit2, i64 0, i64 0
  call i32 @puts(i8* %reg5)
  br label %if_end_L1
if_end_L1:
  br label %loop_header_L2
loop_header_L2:
  %reg6 = load i1, i1* %reg2
  br i1 %reg6, label %loop_body_L2, label %loop_end_L2
loop_body_L2:
  %reg7 = load i1, i1* %reg2
  %reg8 = call i8* @bool_to_string(i1 %reg7)
  call i32 @puts(i8* %reg8)
  %reg9 = and i1 false, false
  store i1 %reg9, i1* %reg2
  %reg10 = load i1, i1* %reg2
  %reg11 = call i8* @bool_to_string(i1 %reg10)
  call i32 @puts(i8* %reg11)
  %reg12 = getelementptr inbounds [7 x i8], [7 x i8]* @lit3, i64 0, i64 0
  %reg13 = getelementptr inbounds [6 x i8], [6 x i8]* @lit4, i64 0, i64 0
  %reg14 = call i8* @concat_strings(i8* %reg12, i8* %reg13)
  %reg15 = load i1, i1* %reg2
  %reg16 = call i8* @bool_to_string(i1 %reg15)
  %reg17 = call i8* @concat_strings(i8* %reg14, i8* %reg16)
  call i32 @puts(i8* %reg17)
  br label %loop_header_L2
loop_end_L2:
  ret i32 0
}
@lit1 = constant [6 x i8] c"hello\00"
@lit2 = constant [6 x i8] c"olleh\00"
@lit3 = constant [7 x i8] c"hello \00"
@lit4 = constant [6 x i8] c"world\00"
